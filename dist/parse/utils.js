...
var Reg = {
  mobile: /(((13[0-9]|14[01456879]|15[0-35-9]|16[2567]|17[0-8]|18[0-9]|19[0-35-9])\d{8})|(((\d{3,4}-)|\d{3.4}-)?\d{7,8}))(\-(\d{4}|\d{3}))?/g,
  phone: /(((13[0-9]|14[01456879]|15[0-35-9]|16[2567]|17[0-8]|18[0-9]|19[0-35-9])\d{8})|(((\d{3,4}-)|\d{3.4}-)?\d{7,8}))(\-(\d{4}|\d{3}))?/g,
  zipCode: /([0-9]{6})/g
};
